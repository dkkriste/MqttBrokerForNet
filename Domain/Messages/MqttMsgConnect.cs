...
namespace MqttBrokerForNet.Domain.Messages
{
    ...
    public class MqttMsgConnect : MqttMsgBase
    {
        ...
        public const string PROTOCOL_NAME_V3_1 = "MQIsdp";
        public const string PROTOCOL_NAME_V3_1_1 = "MQTT"; // [v.3.1.1]

        // max length for client id (removed in 3.1.1)
        public const int CLIENT_ID_MAX_LENGTH = 23;

        // variable header fields
        public const byte PROTOCOL_NAME_LEN_SIZE = 2;
        public const byte PROTOCOL_NAME_V3_1_SIZE = 6;
        public const byte PROTOCOL_NAME_V3_1_1_SIZE = 4; // [v.3.1.1]
        public const byte PROTOCOL_VERSION_SIZE = 1;
        public const byte CONNECT_FLAGS_SIZE = 1;
        public const byte KEEP_ALIVE_TIME_SIZE = 2;

        public const byte PROTOCOL_VERSION_V3_1 = 0x03;
        public const byte PROTOCOL_VERSION_V3_1_1 = 0x04; // [v.3.1.1]
        public const ushort KEEP_ALIVE_PERIOD_DEFAULT = 60; // seconds
        public const ushort MAX_KEEP_ALIVE = 65535; // 16 bit

        // connect flags
        public const byte USERNAME_FLAG_MASK = 0x80;
        public const byte USERNAME_FLAG_OFFSET = 0x07;
        public const byte USERNAME_FLAG_SIZE = 0x01;
        public const byte PASSWORD_FLAG_MASK = 0x40;
        public const byte PASSWORD_FLAG_OFFSET = 0x06;
        public const byte PASSWORD_FLAG_SIZE = 0x01;
        public const byte WILL_RETAIN_FLAG_MASK = 0x20;
        public const byte WILL_RETAIN_FLAG_OFFSET = 0x05;
        public const byte WILL_RETAIN_FLAG_SIZE = 0x01;
        public const byte WILL_QOS_FLAG_MASK = 0x18;
        public const byte WILL_QOS_FLAG_OFFSET = 0x03;
        public const byte WILL_QOS_FLAG_SIZE = 0x02;
        public const byte WILL_FLAG_MASK = 0x04;
        public const byte WILL_FLAG_OFFSET = 0x02;
        public const byte WILL_FLAG_SIZE = 0x01;
        public const byte CLEAN_SESSION_FLAG_MASK = 0x02;
        public const byte CLEAN_SESSION_FLAG_OFFSET = 0x01;
        public const byte CLEAN_SESSION_FLAG_SIZE = 0x01;
        // [v.3.1.1] lsb (reserved) must be now 0
        public const byte RESERVED_FLAG_MASK = 0x01;
        public const byte RESERVED_FLAG_OFFSET = 0x00;
        public const byte RESERVED_FLAG_SIZE = 0x01;
        ...
        public static MqttMsgConnect Parse(byte fixedHeaderFirstByte, byte protocolVersion, byte[] buffer)
        {
            int index = 0;
